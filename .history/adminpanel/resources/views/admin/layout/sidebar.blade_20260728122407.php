            ...
            <div class="sticky">
                <aside class="app-sidebar sidebar-scroll">
                    <div class="main-sidebar-header active">
                        <a class="desktop-logo logo-light active" href="{{ route('admin.dashboard') }}"><img src="{{ asset('admin/assets/images/brand/logo.png') }}" class="main-logo" alt="logo"></a>
                        <a class="desktop-logo logo-dark active" href="{{ route('admin.dashboard') }}"><img src="{{ asset('admin/assets/images/brand/logo1.png') }}" class="main-logo" alt="logo"></a>
                        <a class="logo-icon mobile-logo icon-light active" href="{{ route('admin.dashboard') }}"><img src="{{ asset('admin/assets/images/brand/favicon.png') }}" alt="logo"></a>
                        <a class="logo-icon mobile-logo icon-dark active" href="{{ route('admin.dashboard') }}"><img src="{{ asset('admin/assets/images/brand/favicon1.png') }}" alt="logo"></a>
                    </div>
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            <li class="slide">
                             ...
                             <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a class="slide-item" href="{{ route('admin.login') }}">
                                            Login
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Widgets</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Forms</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Charts</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Tables</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Elements</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Icons</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Error Pages</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li class="side-menu-label1">
                                        <a href="javascript:void(0)">Utilities</a></li>
